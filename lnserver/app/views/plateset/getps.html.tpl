...
<dev>
<p>
  <input type="radio" id="group" name="buttons" value="group" onchange="getpsSelection(event)"><label for="group">Group</label><label>(2 or more Plate Sets of the same format and layout)</label></p>
 <p> <input type="radio" id="reformat" name="buttons" value="reformat" onchange="getpsSelection(event)"><label for="reformat">Reformat</label><label>(a single Plate Set)</label></p>
